 ...
 */
public class VentanaAdvertenciaSalir extends javax.swing.JFrame {
    ...
    private ImageIcon AdvertenciaSalida;
    //Imagen Botones "No"
    ...
    /*-------------------------------------Metodos-------------------------------------*/
    public VentanaAdvertenciaSalir() {
        initComponents();
        ...
        AdvertenciaSalida = new ImageIcon("src/Imagenes_Wallpapers/AdvertenciaSalida.png");
        this.fondo.setIcon(new ImageIcon(AdvertenciaSalida.getImage().getScaledInstance(fondo.getWidth(), fondo.getHeight(), Image.SCALE_SMOOTH)));
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(545, 395));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAdvertenciaSalir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAdvertenciaSalir().setVisible(true);
            }
        });
    }
